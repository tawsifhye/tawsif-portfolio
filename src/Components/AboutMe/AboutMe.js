                    ...
                    <div data-aos="fade-left" className="p-5 flex flex-col align-middle justify-items-center">
                        ...
                        <div data-aos="zoom-in" id="skills">
                            ...
                            <div id="familiar-skills" className="mt-3">
                                ...
                                <div className="bg-blue-300 font-black inline-block mr-3 mt-3 py-2 px-2 ring-2 ring-indigo-800 rounded-lg ">React Native</div>
                                ...
                                <div className="bg-blue-300 font-black inline-block mr-3 mt-3 py-2 px-2 ring-2 ring-indigo-800 rounded-lg ">OOP</div>
                            </div>
